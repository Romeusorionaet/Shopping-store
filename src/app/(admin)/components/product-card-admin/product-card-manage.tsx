    ...
    <div className="flex flex-col justify-center gap-4">
      ...
      <div className="flex flex-wrap justify-center gap-4">
        <div className="group h-72 w-72 md:h-[26rem]">
          <div className="relative flex flex-col items-center justify-center gap-1 rounded-md bg-base_reference_card p-1 duration-700 hover:bg-base_reference_card_hover data-[quantity=true]:bg-base_color_dark/5 data-[quantity=true]:hover:bg-base_color_dark/10 md:h-full md:gap-2 md:p-4">
